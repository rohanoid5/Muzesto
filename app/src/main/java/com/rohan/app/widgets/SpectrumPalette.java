...
public class SpectrumPalette extends LinearLayout {
    ...
    public SpectrumPalette(Context context, AttributeSet attrs) {
        ...
        TypedArray a = getContext().getTheme().obtainStyledAttributes(attrs, com.thebluealliance.spectrum.R.styleable.SpectrumPalette, 0, 0);

        int id = a.getResourceId(com.thebluealliance.spectrum.R.styleable.SpectrumPalette_spectrum_colors, 0);
        if (id != 0) {
            mColors = getContext().getResources().getIntArray(id);
        }

        mAutoPadding = a.getBoolean(com.thebluealliance.spectrum.R.styleable.SpectrumPalette_spectrum_autoPadding, false);
    ...
    private ColorItem createColorItem(int color, int selectedColor) {
        ...
        LayoutParams params = new LayoutParams(mColorItemDimension, mColorItemDimension);
