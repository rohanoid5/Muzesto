...
/**
 * A version of {@link com.thebluealliance.spectrum.SpectrumPreference} meant to be used with the support library Preferences.
 *
...
public class SpectrumPreferenceCompat extends DialogPreference {
    ...
    public SpectrumPreferenceCompat(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.thebluealliance.spectrum.R.styleable.SpectrumPreference, 0, 0);
        try {
