...
public class SpectrumPreference extends DialogPreference {
    ...
    public SpectrumPreference(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.thebluealliance.spectrum.R.styleable
                .SpectrumPreference, 0, 0);
        try {
            int id = a.getResourceId(com.thebluealliance.spectrum.R.styleable.SpectrumPreference_spectrum_colors, 0);
            if (id != 0) {
                mColors = getContext().getResources().getIntArray(id);
            }
            mCloseOnSelected = a.getBoolean(com.thebluealliance.spectrum.R.styleable.SpectrumPreference_spectrum_closeOnSelected, true);
            mOutlineWidth = a.getDimensionPixelSize(com.thebluealliance.spectrum.R.styleable.SpectrumPalette_spectrum_outlineWidth, 0);
            mFixedColumnCount = a.getInt(com.thebluealliance.spectrum.R.styleable.SpectrumPalette_spectrum_columnCount, -1);
        } finally {
            a.recycle();
        }

        setDialogLayoutResource(com.thebluealliance.spectrum.R.layout.dialog_color_picker);
        setWidgetLayoutResource(com.thebluealliance.spectrum.R.layout.color_preference_widget);
    }
    ...
    protected void onBindView(View view) {
        ...
        mColorView = view.findViewById(com.thebluealliance.spectrum.R.id.color_preference_widget);
        updateColorView();
    }
    ...
    private void updateColorView() {
        ...
        if (!isEnabled()) {
            ...
            drawable.setAlpha(0);
            drawable.setOutlineWidth(getContext().getResources().getDimensionPixelSize(com.thebluealliance.spectrum.R.dimen.color_preference_disabled_outline_size));
    ...
    protected void onBindDialogView(View view) {
        ...
        mColorPalette = (SpectrumPalette) view.findViewById(com.thebluealliance.spectrum.R.id.palette);
