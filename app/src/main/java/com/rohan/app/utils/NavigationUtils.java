...
import com.rohan.app.activities.PlaylistDetailActivity;
import com.rohan.app.activities.SearchActivity;
...
public class NavigationUtils {
    ...
    String unitType = sharedPrefs.getString(R.string.pref_units_key, R.string.pref_units_timber4);*/
