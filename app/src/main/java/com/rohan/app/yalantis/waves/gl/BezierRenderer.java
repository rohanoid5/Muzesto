 ...
 */
public class BezierRenderer extends com.yalantis.waves.gl.BezierRenderer implements GLSurfaceView.Renderer {
    /**
    ...
    public com.yalantis.waves.gl.CubicBezier[] mBezierCurves;
    ...
    public BezierRenderer(GLSurfaceView glSurfaceView, @ColorInt int backgroundColor) {
        super(glSurfaceView,backgroundColor);
