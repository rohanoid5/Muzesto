package com.rohan.app.yalantis.waves.gl;

import android.graphics.Color;

import com.yalantis.waves.Const;
import com.yalantis.waves.gl.*;
import com.yalantis.waves.gl.Buffers;
import com.yalantis.waves.gl.CubicBezier;
...
public class VerticesDataGenerator implements Runnable {
    ...
    private final com.yalantis.waves.gl.BezierRenderer mBezierRenderer;

    public VerticesDataGenerator(com.yalantis.waves.gl.BezierRenderer bezierRenderer) {
        ...
        mBezierRenderer.mGlSurfaceView.queueEvent(new Runnable() {
            ...
            public void run() {
                if (mBezierRenderer.mBezierCurves != null) {
                    for (com.yalantis.waves.gl.CubicBezier bezierCurve : mBezierRenderer.mBezierCurves) {
                        bezierCurve.release();
                    }
                ...
                com.yalantis.waves.gl.CubicBezier[] bezierCurves = new com.yalantis.waves.gl.CubicBezier[10];

                bezierCurves[0] = new com.yalantis.waves.gl.CubicBezier(
                        mBezierRenderer,
                        buffer,
                        -1, 0,
                        -0.610f, 0.244f,
                ...
                bezierCurves[1] = new com.yalantis.waves.gl.CubicBezier(
                        mBezierRenderer,
                        buffer,
                        -0.610f, 0.244f,
                        1, 0,
                ...
                bezierCurves[2] = new com.yalantis.waves.gl.CubicBezier(
                        mBezierRenderer,
                        buffer,
                             -1, 0,
                        -0.305f, 0.360f,
                ...
                bezierCurves[3] = new com.yalantis.waves.gl.CubicBezier(
                        mBezierRenderer,
                        buffer,
                        -0.305f, 0.360f,
                         1, 0,
                ...
                bezierCurves[4] = new com.yalantis.waves.gl.CubicBezier(
                        mBezierRenderer,
                        buffer,
                        -1, 0,
                        0, 0.488f,
                ...
                bezierCurves[5] = new com.yalantis.waves.gl.CubicBezier(
                        mBezierRenderer,
                        buffer,
                        1, 0,
                        0, 0.488f,
                ...
                bezierCurves[6] = new com.yalantis.waves.gl.CubicBezier(
                        mBezierRenderer,
                        buffer,
                         1, 0,
                         0.305f, 0.360f,
                ...
                bezierCurves[7] = new com.yalantis.waves.gl.CubicBezier(
                        mBezierRenderer,
                        buffer,
                         0.305f, 0.360f,
                        -1, 0,
                ...
                bezierCurves[8] = new com.yalantis.waves.gl.CubicBezier(
                        mBezierRenderer,
                        buffer,
                        1, 0,
                        0.610f, 0.244f,
